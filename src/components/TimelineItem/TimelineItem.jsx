...
function TimelineItem(props) {
    ...
    return (
        ...
        <td><Button variant="contained" sx={{ backgroundColor: '#8075FF', ":hover": {backgroundColor: 'secondary'}}} color="secondary" onClick={() => handleDeleteTimeline(props.item.id)}>Delete</Button></td>
        </tr>
        </>
    )
}
